        ...
        <div className='flex flex-col xl:flex-row justify-center items-center p-8 h-full w-full min-w-[300px]'>
          ...
          <div className='flex items-center justify-center w-full h-2/3 xl:w-1/2 xl:h-5/6 bg-gray-200 shadow-xl rounded-b-2xl xl:rounded-none xl:rounded-r-2xl overflow-auto p-4 max-w-[700px]'>
            <p className='text-justify text-lg 2xl:text-2xl  h-full font-semibold tracking-wide pb-8 relative'>
              ...
              - de Colt Steele où j&apos;ai découvert le HTML, le CSS,
              Javascript, Node et MongoDB.
              <br />
              En 2021, j&apos;ai rejoint le Bootcamp -{' '}
              <span className='font-bold italic'>
                Complete React Developer{' '}
              </span>
              - d&apos;Andrei Neagoie et Yihua Zang, et j&apos;ai été fasciné
              par le potentiel de{' '}
              ...
              <span className='font-extrabold uppercase'>Firebase</span>. Nous
              sommes en 2023 et, en parallèle des projets sur lesquels j&apos;ai
              travaillé, je me concentre sur NextJS qui apporte à React de
              nouvelles fonctionnalités et de meilleures performances.
              <br />
