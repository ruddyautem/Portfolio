export const cvData = {
  en: {
    ...
    contacts: [
      ...
      { icon: '/linkedinIcon.svg', text: '/ruddyautem', link: 'https://www.linkedin.com/in/ruddyautem/' }
    ],
    skillGroups: [
    ...
    projects: [
      { title: 'Temporis', year: '2026', link: 'https://temporis.autem.dev', points: [
      ...
      { title: 'VsCode Portfolio', year: '2026', link: 'https://autem.dev', points: [
          'Design and creation of a fully responsive Next.js portfolio inspired by the VSCode interface.',
          'Integration of dynamic color themes improving visual appeal and usability.',
          'Addition of a high-performance messaging service ensuring smooth and efficient contact.'
        ] },
      { title: 'Stokki', year: '2025', link: 'https://stokki.autem.dev', points: [
      ...
      { title: 'Style-D', year: '2024', link: 'https://style-d.autem.dev', points: [
    ...
    formations: [
      { title: 'Complete React Developer, Redux, Hooks', institution: 'Zero To Mastery Academy', year: '2022' },
      { title: 'The Web Developer Bootcamp', institution: 'Colt Steele', year: '2021' },
      { title: 'Bachelor\'s Degree LLCER - Foreign and Regional Languages, Literatures and Civilizations', institution: 'Sorbonne Nouvelle - Paris 3', year: '2014' }
    ],
    languages: [
  ...
  fr: {
    ...
    projects: [
      ...
      { title: 'Portfolio VsCode', year: '2026', link: 'https://autem.dev', points: [
    ...
    formations: [
      { title: 'Complete React Developer, Redux, Hooks', institution: 'Zero To Mastery Academy', year: '2022' },
      { title: 'The Web Developer Bootcamp', institution: 'Colt Steele', year: '2021' },
      { title: 'Licence LLCER - Langues, littératures et civilisations étrangères et régionales', institution: 'Sorbonne Nouvelle - Paris 3', year: '2014' }
    ],
    languages: [
...
export const getCvData = (locale) => cvData[locale] || cvData.en;
