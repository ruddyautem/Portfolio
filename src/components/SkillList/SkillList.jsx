...
const SkillList = ({ skill, icon, altText, category }) => {
  const categoryStyles = {
    frontend: {
      ...
      hoverGradient: 'hover:from-blue-500/25 hover:via-blue-400/15 hover:to-blue-300/10',
    ...
    backend: {
      ...
      hoverGradient: 'hover:from-purple-500/25 hover:via-purple-400/15 hover:to-purple-300/10',
    ...
    outils: {
      ...
      hoverGradient: 'hover:from-emerald-500/25 hover:via-emerald-400/15 hover:to-emerald-300/10',
      ...
      iconHover: 'group-hover:from-emerald-400/30 group-hover:to-emerald-500/25',
  ...
  return (
    ...
    >
      ...
      >
        ...
        <div
          className="absolute top-6 right-2 h-0.5 w-0.5 animate-pulse rounded-full bg-white/40
            delay-100"
        ></div>
        <div
          className="absolute bottom-4 left-3 h-1 w-1 animate-pulse rounded-full bg-white/30
            delay-200"
        ></div>
      </div>
      ...
      {/* Main content */}
      <div
        className="relative z-10 flex h-full flex-col items-center justify-center p-2 sm:p-3 2xl:p-4
          3xl:p-5"
      >
        {/* Icon container */}
        <div
          className={`relative mb-2 sm:mb-3 2xl:mb-4 3xl:mb-5 flex h-10 w-10 sm:h-12 sm:w-12 md:h-14
            md:w-14 xl:h-16 xl:w-16 2xl:h-18 2xl:w-18 3xl:h-20 3xl:w-20 items-center justify-center
            rounded-lg sm:rounded-xl 2xl:rounded-2xl 3xl:rounded-3xl ${style.iconBg}
            ${style.iconHover} border border-white/20 shadow-lg transition-all duration-300
        ...
        >
          ...
          <Image
            ...
            className="relative z-10 object-contain transition-all duration-300
              group-hover:brightness-110 group-hover:contrast-110 w-6 h-6 sm:w-7 sm:h-7 md:w-8
              md:h-8 xl:w-9 xl:h-9 2xl:w-[42px] 2xl:h-[42px] 3xl:w-12 3xl:h-12"
          />
        </div>

        {/* Skill name */}
        <h3
          className={`relative text-center text-xs sm:text-sm md:text-base 2xl:text-base 3xl:text-lg
            font-semibold text-white/95 transition-all duration-300 group-hover:scale-105
            group-hover:text-white ${style.textGlow} leading-tight tracking-wide`}
        >
          {skill}
        </h3>
