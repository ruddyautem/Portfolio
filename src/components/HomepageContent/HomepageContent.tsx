    ...
    >
      <div className="relative z-10 flex w-full max-w-6xl flex-col 2xl:max-w-400">
        ...
        >
          ...
          <div
            className="flex w-full flex-col justify-between overflow-y-auto p-4 sm:p-6 md:p-8
              lg:flex-1 lg:overflow-y-hidden lg:px-6 lg:py-2.5 xl:p-5 2xl:p-8 2xl:pb-6
              3xl:p-12 3xl:pb-10"
          >
            <div
              className="flex w-full min-w-0 flex-col gap-6 lg:grid lg:grid-cols-2 lg:items-center
                lg:gap-4 xl:gap-8 2xl:gap-12 3xl:gap-16"
            >
